...
const siteData = {
  ...
  intro: 'i\'m an undergraduate @ <span class="hl">uc berkeley</span>, studying data science with applied math as domain emphasis. right now i\'m splitting time between an engineering internship at Guang Labs, a data science internship at IDX Exchange, and course staff for CS 61A. my interests are in <span class="hl">multimodal ai + reinforcement learning</span>.',
  about: {
    bio: [
